          ...
          <aside className="w-[400px] flex-shrink-0">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-200 shadow-sm sticky top-6">
              ...
              <div className="relative h-48">
                <img
                  src="https://images.unsplash.com/photo-1497366216548-37526070297c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvZmZpY2UlMjBidWlsZGluZyUyMGV4dGVyaW9yfGVufDF8fHx8MTc2MDg2MDcxMXww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Job header"
