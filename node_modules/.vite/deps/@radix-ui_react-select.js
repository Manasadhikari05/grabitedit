...
import {
  ...
  shift,
  size
} from "./chunk-GHLACPNK.js";
import {
  createContextScope,
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-4OSK4BH3.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-PUD4RC3N.js";
import {
  require_react_dom
...
function useSize(element) {
  const [size3, setSize] = React11.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow3, setArrow] = React12.useState(null);
